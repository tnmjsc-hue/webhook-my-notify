    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Tạo tài khoản WMN</h1>
          <p className="text-sm text-zinc-500 mt-2">Bắt đầu miễn phí — gói Free ngay lập tức</p>
        </div>
        ...
        <p className="text-center text-sm text-zinc-500 mt-6">
          Đã có tài khoản?{' '}
          <Link href="/login" className="text-zinc-900 dark:text-white font-medium hover:underline">Đăng nhập</Link>
        </p>
      </div>
    </div>
  )
